...
<body>
    ...
    <ol>
        ...
        <li>User can add/remove+start/finish/cancel a task;</li>
        <li>A new task is created in status "To Do". Other statuses are "In progress", "Canceled", "Done";</li>
        <li>Implement Google Analystics;</li>
    </ol>
    <h2>To Do</h2>
    <ul>
        ...
        <li>Tabs (task pools): "todoit.pro", "All", "My";</li>
        <li>Voting system: 1) vote up or down a task; 2) vote + or - for a solution of a task;</li>
        <li>Update Git README.md</li>
        <li>SEO;</li>
    </ul>
    <h2>Done</h2>
    <ul>
